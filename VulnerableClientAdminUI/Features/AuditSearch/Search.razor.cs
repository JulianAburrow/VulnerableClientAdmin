namespace VulnerableClientAdminUI.Features.AuditSearch;
...
public partial class Search
{
    ...
    private async void DoSearch()
    {
        ...
        AuditObjects = await AuditObjectHandler.GetLastAuditRecordsForObjectAsync($"{ObjectType}Model", ObjectId);
        HideSearchBox = true;
        StateHasChanged();
    }
